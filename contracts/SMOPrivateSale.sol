...
contract SMOPrivateSale {
    ...
    uint256 public totalTokensToSell = 30000000 * 10**18;          // 30000000 SMO tokens for sell
    uint256 public smoPerBnb = 10000 * 10**18;             // 1 BNB = 10000 SMO
