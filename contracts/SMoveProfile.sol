...
// File: @smove/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/SMoveProfile.sol
...
*/
contract SMoveProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public smoToken;
    ...
    uint256 public numberSmoToReactivate;
    uint256 public numberSmoToRegister;
    uint256 public numberSmoToUpdate;
    ...
    constructor(
        IBEP20 _smoToken,
        uint256 _numberSmoToReactivate,
        uint256 _numberSmoToRegister,
        uint256 _numberSmoToUpdate
    ) public {
        smoToken = _smoToken;
        numberSmoToReactivate = _numberSmoToReactivate;
        numberSmoToRegister = _numberSmoToRegister;
        numberSmoToUpdate = _numberSmoToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends SMO to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer SMO tokens to this contract
        smoToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSmoToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer SMO token to this address
        smoToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSmoToUpdate
    ...
    /**
     * @dev Claim SMO to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        smoToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of SMO to register
     * Callable only by owner admins.
     */
    function updateNumberSmo(
        uint256 newNumberSmoToReactivate,
        uint256 _newNumberSmoToRegister,
        uint256 _newNumberSmoToUpdate
    ) external onlyOwner {
        numberSmoToReactivate = newNumberSmoToReactivate;
        numberSmoToRegister = _newNumberSmoToRegister;
        numberSmoToUpdate = _newNumberSmoToUpdate;
    }
