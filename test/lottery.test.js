...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.smo = await MockBEP20.deployed();
        ...
        await this.smo.transfer(bob, '2000', { from: minter });
        await this.smo.transfer(alice, '2000', { from: minter });
        await this.smo.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.smo.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.smo.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.smo.balanceOf(this.lotteryProxyAddress)).toString(), '418');
